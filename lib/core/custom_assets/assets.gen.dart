...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/dailyTopper.png
  AssetGenImage get dailyTopper =>
      const AssetGenImage('assets/images/dailyTopper.png');

  /// File path: assets/images/dummy2.png
  AssetGenImage get dummy2 => const AssetGenImage('assets/images/dummy2.png');

  /// File path: assets/images/dummyImage.png
  AssetGenImage get dummyImage =>
      const AssetGenImage('assets/images/dummyImage.png');
  ...
  /// File path: assets/images/international.png
  AssetGenImage get international =>
      const AssetGenImage('assets/images/international.png');

  /// File path: assets/images/national.png
  AssetGenImage get national =>
      const AssetGenImage('assets/images/national.png');

  /// File path: assets/images/politics.png
